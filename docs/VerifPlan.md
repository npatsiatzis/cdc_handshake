...
1. **Scope**
   ...
   This document establishes the verification plan for the cdc handshake design specified in
...
verification approaches for the cdc handshake design as specified in the requirement 
specification number cdc handshake_req_001(Specification.md).
...
1. **Non-government Documents**
   ...
   Document #: cdc handshake_req_001(Specification.md), Requirement Specification for cdc handshake.
...
* **Test application approach for the cdc handshake**
...
to mimic a cdc handshake in a system environment. The environment will perform the
following transactions at pseudo-random intervals: 
   ...
   | Reset | Directed Test | set reset signal active (high) | All components of cdc handshake enter reset state |
