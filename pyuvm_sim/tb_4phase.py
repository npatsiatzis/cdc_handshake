...
import cocotb
import pyuvm
from utils_4phase import HandShake4PhaseBfm
...
@CoverPoint("top.i_data",xf = lambda x : x, bins = list(range(2**g_width)), at_least=1)
def number_cover(x):
    pass
...
@pyuvm.test()
class Test(uvm_test):
    """Test cdc 4 phase handshake with random values"""
